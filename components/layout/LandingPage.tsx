        ...
        <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-blue-50 via-white to-blue-50">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
              Transforming law enforcement record-keeping with real-time digital
              occurrence book management
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                The Digital Occurrence Book (OB) system is a transformative
                platform designed to modernize how Kenya Police Service manages
                crime records, cases, and investigations. By integrating
                administration, police operations, and the judiciary into a
                unified digital ecosystem, we're creating a more efficient,
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-lg">
                    To establish a comprehensive digital infrastructure for
                    continuous data collection, secure storage, and intelligent
                    management of all police occurrence book entries across
                    Kenya, enabling data-driven decision-making and fostering
                    collaboration between law enforcement and judicial systems.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="structure" className="py-20 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Digital OB is designed to match Kenya Police Service hierarchy,
                with role-based access and features tailored to each command
                level
              </p>
            </div>
              ...
              {hierarchy.map((level, index) => (
                ...
                >
                  <button
                    onClick={() =>
                      setSelectedRank(
                        selectedRank === level.level ? null : level.level,
                      )
                    }
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Login with your service credentials and access features
                    based on your rank and assignment. The system automatically
                    grants appropriate permissions according to Kenya Police
                    Service hierarchy.
                  </p>
                </div>
              </div>
        ...
        <section className="py-20 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Access Digital OB through multiple platforms designed for your
                workflow
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Access your personalized dashboard with secure login. Your
              permissions and features will be automatically configured based on
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-500">
                © 2026 Kenya Police Service. All rights reserved. | Version
                2.0.1
              </p>
